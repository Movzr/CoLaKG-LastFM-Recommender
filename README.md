...
### 数据集来源
LastFM 数据集与数据组织方式均来自 CoLaKG 官方仓库：  
https://github.com/ziqiangcui/CoLaKG-SIGIR25  
...
- lastfm_embeddings_simcse_kg_user.pt：用户语义 embedding  
...
生成：  
data/lastfm/colakg_trained_embeddings.pt  
